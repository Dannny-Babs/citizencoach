...
export function TwoPaneLayout({ left, right }: TwoPaneLayoutProps) {
  return (
    <div className="h-screen p-4">
      <div className="h-full grid grid-cols-1 md:grid-cols-2 gap-2 max-w-7xl mx-auto">
        
        {/* Left Pane - Chat Interface */}
        <div className="flex flex-col bg-white rounded-xl  border border-gray-100 overflow-hidden">
          {left}
        </div>
