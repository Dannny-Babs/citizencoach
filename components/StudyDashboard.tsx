        ...
        <div className="flex flex-col h-full">
            ...
            <div className="p-6 border-b border-slate-200">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-xl font-semibold text-gray-900">Study Dashboard</h2>
                ...
                <div className="flex space-x-1 bg-white rounded-lg p-1 border border-slate-200">
                    {[
                        { key: 'topics' as ViewMode, label: 'Topics', icon: '📚' },
                        { key: 'flashcards' as ViewMode, label: 'Cards', icon: '🃏' },
                        { key: 'progress' as ViewMode, label: 'Progress', icon: '📈' }
                    ].map((tab) => (
                        <button
                            key={tab.key}
                            onClick={() => setViewMode(tab.key)}
                            className={`flex-1 flex items-center justify-center space-x-2 py-2 px-3 rounded-md text-sm font-medium transition-colors ${viewMode === tab.key
